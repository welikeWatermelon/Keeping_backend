...
public class IdempotentResult<T> {
    ...
    public static <T> IdempotentResult<T> created(T body) {
        return new IdempotentResult<>(HttpStatus.CREATED, body, false, null);
    }
    ...
    public static <T> IdempotentResult<T> okReplay(T body) {
        return new IdempotentResult<>(HttpStatus.OK, body, true, null);
    }

    public static <T> IdempotentResult<T> accepted() {
        return new IdempotentResult<>(HttpStatus.ACCEPTED, null, false, null);
    }
